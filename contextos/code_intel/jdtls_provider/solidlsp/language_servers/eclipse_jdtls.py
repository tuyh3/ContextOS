            ...
            "initializationOptions": {
                ...
                "settings": {
                    "java": {
                        ...
                        "settings": {"url": None},
                        "symbols": {
                            # CONTEXTOS PATCH: True (upstream default False) so workspace/symbol
                            # returns method declarations, not only types. 04 code_search needs
                            # method-level seeds; manual test 2026-06-01 showed default False made
                            # methods (execQueryByRoute) + fields invisible to workspaceSymbol.
