...
# CONTEXTOS VENDORING: inlined from serena.constants to drop the serena package dep.
DEFAULT_SOURCE_FILE_ENCODING = "utf-8"
# CONTEXTOS VENDORING: rewritten to relative import (solidlsp is vendored as a sibling).
from ..ls_utils import TextUtils
